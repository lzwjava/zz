...
Usage:
  ...
  # Full 100B tokens (~400 GB) — fills most of the disk
  python scripts/download/plan_and_download_fineweb_gpt3_amd.py --tokens 100000000000

  # Force re-list shards from the Hub
  python scripts/download/plan_and_download_fineweb_gpt3_amd.py --refresh-plan
"""
...
DEFAULT_TOKENS = 10_000_000_000  # 10B tokens (~40 GB) — conservative default
BYTES_PER_TOKEN = 4.0
